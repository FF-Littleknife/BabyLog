...
function WheelColumn({
  ...
  function updateByScroll() {
    ...
    const nextValue = Math.round(
      wheel.scrollTop / SHEET.wheelItemHeight
    );
          ...
          return (
            <button
              ...
              style={{
                height: SHEET.wheelItemHeight,
                color: active
                  ? SHEET.wheelActiveColor
                  : SHEET.wheelTextColor,
                fontSize: active
                  ? SHEET.wheelActiveSize
                  : SHEET.wheelTextSize,
                fontWeight: active
...
export default function BreastRecordSheet({
  onClose,
  onSave,
}: {
  onClose: () => void;
  ...
  function save() {
    ...
    const left = Number(leftMin || 0);
    const right = Number(rightMin || 0);
    ...
    onSave({
      ...
      leftMin: left || undefined,
      rightMin: right || undefined,

      durationMin: left + right || undefined,
  ...
  return (
    <div className="sheet-backdrop" onClick={onClose}>
      ...
      >
        ...
        >
          <div style={fieldStyle}>
            <label style={labelStyle}>左侧 分钟</label>
          ...
          <div style={fieldStyle}>
            <label style={labelStyle}>右侧 分钟</label>
