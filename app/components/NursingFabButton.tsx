...
const NURSING_FAB_CONFIG = {
  bg: "var(--surface-soft, rgba(255, 255, 255, 0.74))",
  activeBg: "#ff0063",
  ...
  shadow: "var(--shadow-float, 0 14px 34px rgba(0, 0, 0, 0.14))",
    ...
    <>
      <style jsx global>{`
        @media (prefers-color-scheme: dark) {
          :root {
            --nursing-fab-idle-bg: rgba(44, 44, 46, 0.72);
            --nursing-fab-idle-shadow: 0 14px 34px rgba(0, 0, 0, 0.48);
          }
        }
      `}</style>
        ...
        style={
          {
            ...
            background: nursing
              ...
              : "var(--nursing-fab-idle-bg, var(--surface-soft, rgba(255, 255, 255, 0.74)))",
            ...
            boxShadow: nursing
              ...
              : "var(--nursing-fab-idle-shadow, var(--shadow-float, 0 14px 34px rgba(0, 0, 0, 0.14)))",
